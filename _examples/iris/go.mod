module github.com/VendSYSTEM/go-redoc/_examples/iris
...
require github.com/VendSYSTEM/go-redoc/iris v0.0.0
...
replace github.com/VendSYSTEM/go-redoc/iris => ../../iris
